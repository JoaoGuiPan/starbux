...
import com.jpan.starbux.common.CONSTANTS.CART_FACT
import com.jpan.starbux.model.Cart
import com.jpan.starbux.service.promotion.MoreThanTwelveEurosDiscountRule
import com.jpan.starbux.service.promotion.ThirdDrinkFreeDiscountRule
...
class DiscountCommand {
    ...
    fun applyDiscounts(cart: Cart) {
        ...
        // set to zero to calculate with updated values
